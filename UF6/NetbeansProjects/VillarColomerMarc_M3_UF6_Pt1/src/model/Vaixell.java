...
public class Vaixell {
    ...
    public Vaixell(int codi, String nom, Categoria categoria, double rating, String club, String tipusVaixell, boolean senior, double tempsReal) {
        this.codi = codi;
        this.nom = nom;
    ...
    public String getTipusVaixell() {
        return tipusVaixell;
    }

    public void setTipusVaixell(String tipusVaixell) {
        this.tipusVaixell = tipusVaixell;
    }
